...
namespace Arrest_Manager
{
    ...
    internal class Main : Plugin
    {
        ...
        public override void Initialize()
        {
            ...
            Game.LogTrivial("Arrest Manager " + Assembly.GetExecutingAssembly().GetName().Version.ToString() + ", by Albo1125 updated by Sparky for LSPDFR 0.4.9, loaded successfully!");
        ...
        internal static Version MadeForGTAVersion = new Version("1.0.3521.1");
